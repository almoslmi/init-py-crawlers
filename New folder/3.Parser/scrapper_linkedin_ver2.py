...
def read_static(params):
    ...
    list_of_files = glob.glob("C:\\Users\\Acer\\Desktop\\code\\linkedin code\\2.Crawler\\Dump\\*.html")
    ...
    for files in effective_list:
    	...
    	# Location Details
                ...
                prev_div = soup.find('tr',{'id':re.compile('overview-summary-previous')})
                prev=[]
            ...
            try:
                ...
                for div in all_org_div:
                    ...
                    #print ds
                    org.append(ds[0].encode('utf-8','replace'))
                    #print ds[1]
